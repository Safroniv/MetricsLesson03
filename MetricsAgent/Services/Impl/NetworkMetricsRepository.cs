...
namespace MetricsAgent.Services.Impl
{
    public class NetworkMetricsRepository : INetworkMetricsRepository
    {
        ...
        public void Create(NetworkMetric item)
        {
            ...
            cmd.CommandText = "INSERT INTO networksmetrics(value, time) VALUES(@value, @time)";
        ...
        public void Delete(int id)
        {
            ...
            cmd.CommandText = "DELETE FROM networksmetrics WHERE id=@id";
        ...
        public NetworkMetric GetById(int id)
        {
            ...
            connection.Open();
            using var cmd = new SQLiteCommand(connection);
            cmd.CommandText = "SELECT * FROM networksmetrics WHERE id=@id";
            using (SQLiteDataReader reader = cmd.ExecuteReader())
            {
        ...
        public IList<NetworkMetric> GetByTimePeriod(TimeSpan timeFrom, TimeSpan timeTo)
        {
            ...
            cmd.CommandText = "SELECT * FROM networksmetrics where time >= @timeFrom and time <= @timeTo";
        ...
        public void Update(NetworkMetric item)
        {
            ...
            cmd.CommandText = "UPDATE networksmetrics SET value = @value, time = @time WHERE id = @id; ";
